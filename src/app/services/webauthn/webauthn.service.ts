...
export class WebAuthnService {
  ...
  async register() {
    const userName = prompt("Enter your username (e.g., email address):") 
    if (!userName) {
      throw new Error("Username is required for registration."); // Error if no username is provided
    }
    ...
    const publicKey: PublicKeyCredentialCreationOptions = {
      ...
      rp: { // Relying Party (your app) information
        name: "Angular-WebAuthn-demo" // Display name of your app
      },
      user: { // User information
        id: this.generateRandomBuffer(16), // A unique identifier for the user
        name: userName, // User's email or username
        displayName: userName// A friendly name for the user
      },
